...
public class CubePacketType {
    ...
    //Packet IDs
    public static final CubePacketType ENTITY_UPDATE_ACKNOWLEDGE = new CubePacketType((byte) 2, "Entity Update Acknowledge");
    public static final CubePacketType MAP_SEED = new CubeWorldSeedPacket();
